...
const handleBillAmountChange = (e: ChangeEvent<HTMLInputElement>): void => {
  ...
  return (
  <div className="flex flex-col items-center justify-center min-h-screen bg-[url('/images/tip-calculator.jpeg')] bg-no-repeat  bg-cover dark:bg-gray-900">
    <Card className="w-full max-w-md p-6 border-4 border-yellow-500  bg-white dark:bg-gray-800 shadow-lg rounded-lg">
      <CardHeader>
        <CardTitle className="text-yellow-400">Tip Calculator</CardTitle>
        <CardDescription>
      ...
      <CardContent className="space-y-4">
        ...
        <Button className="bg-yellow-400 text-orange-600 hover:bg-yellow-200 " onClick={calculateTip}>Calculate</Button>
      </CardContent>
