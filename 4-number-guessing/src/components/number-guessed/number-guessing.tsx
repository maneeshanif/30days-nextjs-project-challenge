...
function NumberGuessing(): JSX.Element {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-[url('/images/number-guessing.png')] bg-cover bg-no-repeat ">
      <div className="bg-[#edbd4d] rounded-lg shadow-lg p-8 w-full max-w-md">
        <h1 className="text-4xl font-bold font-serif text-center mb-2 text-[#3fa6f4]">
          Number Guessing Game 🤔
        </h1>
        <p className="text-center text-pink-700 font-mono font-bold mb-4">
        ...
        {!gameStarted && (
          <div className="flex justify-center mb-4">
            <Button
              ...
              className="bg-[#e2892a] hover:bg-gray-700 text-white font-bold py-2 px-4 rounded"
            >
              Start Game
            </Button>
          </div>
