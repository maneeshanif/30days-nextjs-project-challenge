...
const BirthdayWish = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% flex items-center justify-center p-4">
      <motion.div
      ...
      >
        <Card className="mx-auto overflow-hidden bg-blue-200 transition-all duration-300 ease-in-out hover:shadow-xl border-2 border-blue-800">
          <CardHeader className="text-center">
            <CardTitle className="text-4xl font-bold text-black">
              Happy 21th Birthday!
            </CardTitle>
            <CardDescription className="text-2xl font-semibold text-green-400">
              Mohummad Anees
            </CardDescription>
            <p className="text-lg font-semibold text-[#6366F1]">June 1st</p>
          </CardHeader>
